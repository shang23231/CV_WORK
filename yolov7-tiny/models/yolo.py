...
# 添加了 E_ELAN, E_ELAN_H,  增加2 ELAN, SPPCSPCSIM 添加3 RepNCSPELAN4（yolov9中的模块）
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC,
                 ...
                 SwinTransformer2Block, ST2CSPA, ST2CSPB, ST2CSPC, SPPCSPC, RepConv,
                 ELAN, SPPCSPCSIM, RepNCSPELAN4, Conv_ATT, PConv, yolov7_tiny_E_ELAN, DySnakeConv, yolov7_tiny_E_ELAN_DySnakeConv,
                 yolov7_tiny_E_ELAN_EMA,yolov7_tiny_E_ELAN_DBB,
        ...
        ######添加bifpn_concat结构#######
            ...
            c2 = sum(ch[x] for x in f)
        ###############################
        elif m is Concat_ATT:     # Concat add attention model #########
            c2 = sum([ch[x] for x in f])
            args=[c2, *args]             # ###########(end)############ #
        elif m is Chuncat:
            c2 = sum([ch[x] for x in f])
